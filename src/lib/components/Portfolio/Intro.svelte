<script>
	const slides = [
		{ src: '/img/Portfolio/intro/1.jpg', alt: 'Слайд 1' },
		{ src: '/img/Portfolio/intro/2.jpg', alt: 'Слайд 2' },
		{ src: '/img/Portfolio/intro/3.jpg', alt: 'Слайд 3' },
		{ src: '/img/Portfolio/intro/4.jpg', alt: 'Слайд 4' }
	];
	...
	<div class="intro__container">
		<div class="intro__content" data-aos="zoom-in-right">
			<h1 class="intro__title">
				Когда дизайн — не про моду,
				<p>а про смысл</p>
			</h1>

			<div class="intro__text">
				<p class="intro__subtitle">
					Мы верим, что мебель — это больше, чем материал. Это часть дома, в котором Вы будете
					встречать утро, строить планы и оставлять воспоминания
				</p>
			</div>
		</div>
